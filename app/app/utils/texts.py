...
TEXTS_RU = {
    ...
    "verify_photo_sent": "📤 Фото отправлено на проверку. Обычно занимает 5-30 минут.\n\nКак только админ подтвердит — твоя анкета станет видна в поиске.",
    "verify_approved": "✅ Верификация пройдена! Твоя анкета теперь видна в поиске. Удачных знакомств! 💘",
    "verify_rejected": "❌ Фото не прошло проверку.\n\nОтправь новое селфи с жестом ✌️ (два пальца у лица), где хорошо видно лицо.",
...
TEXTS_EN = {
    ...
    "verify_photo_sent": "📤 Photo sent for review. Usually takes 5-30 minutes.\n\nOnce approved, your profile becomes visible in search.",
    "verify_approved": "✅ Verification passed! Your profile is now visible. Happy dating! 💘",
    "verify_rejected": "❌ Photo was rejected.\n\nSend a new selfie with ✌️ gesture (two fingers near your face), face clearly visible.",
